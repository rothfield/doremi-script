...
cat $1 | java -jar $dirname/../target/doremi-script-standalone.jar --json | tee $fname.json | doremi_json_to_lilypond | tee $fname.ly |  lilypond -o $fname -f png - ; feh $fname.png
...
#cat $1 | java -jar $dirname/../target/doremi-script-standalone.jar --json > $fname.json ; cat $fname.json | doremi_json_to_lilypond > $fname.ly ; lilypond -o $fname --png $fname.ly ; feh $fname.png
