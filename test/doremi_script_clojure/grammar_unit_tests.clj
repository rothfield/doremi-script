...
(deftest composition-should-prioritize-sargam-section-over-lyric-section
         (is (good-parse "S" :SECTION  [:SARGAM_SECTION]))
 )
...
;(upper-octave-line)
;;(chord)
(composition-should-prioritize-sargam-section-over-lyric-section)
