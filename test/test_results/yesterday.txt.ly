...
\grace s64 \bar "|"  e'4^"A11" r4 e'4^"A7" r4 \bar "|"  a'4 b'4^"i" c''4^"Bb" b'8 a'8 \bar "|"  b'4 r8 a'8 g'4^"C" b'4 \bar "|"  c''4(^"F"^"_____" g'4 f'4 e'4) \bar ":|"  c''4^"F"^"______" r4 r4 r4 \bar "||"  \break
